...
class AweberMdsSyncAuditReportWriter
{
    ...
    const LIST_AWEBER_EMAILS_NOT_IN_MDS_FILE_NAME           = 'aweber_emails_not_in_mds.xlsx';
    ...
    const AWEBER_UPDATES_LIST_HEADER_ARRAY = array(
            ...
            'MDS Vehicle Reg Exp Interval Remaining',
            'MDS Homeowner Ins Exp Interval Remaining',
    ...
    const  AWEBER_UPDATES_LIST_AWEBER_MDS_SYNC_AUDIT_COL_NAMES = array(
                        ...
                        'mdsVehicleRegIntervalRemaining',
                        'mdsHomeownerInsIntervalRemaining',
                        'mdsStorageLkrClBldg',
                        'mdsStorageLkrNum',
                        ...
                        'aweberVehicleRegIntervalRemaining',
                        'aweberHomeownerInsIntervalRemaining',
...
/*                 $modulo = $rowCtr % self::LIST_AWEBER_UPDATES_BATCH_SIZE;
                 ...
                 if ($modulo == 0) {
                   ...
                   // $writer->save($this->appOutputDir . '/' . self::LIST_AWEBER_EMAILS_NOT_IN_MDS_FILE_NAME_BASE . $fileWriteCtr . self::EXCEL_FILENAME_SUFFIX);
                     $writer->save($this->appOutputDir . '/' . self::LIST_AWEBER_EMAILS_NOT_IN_MDS_FILE_NAME);
     ...
     *     with each other but they are in fact co-dependent.
      ...
      public function generateAweberUpdatesListFailedWithMemoryIssues()
      {
          ...
          $colNamesByHeaderNameKeys = array (
                                 ...
                                 'MDS Vehicle Reg Exp Days Left' => 		'mdsVehicleRegIntervalRemaining',
                                 'MDS Homeowner Ins Exp Days Left' =>	'mdsHomeownerInsIntervalRemaining',
                                 ...
                                 'Aweber Vehicle Reg Exp Days Left' =>	'aweberVehicleRegIntervalRemaining',
                                 'Aweber Homeowner Ins Exp Days Left' => 'aweberHomeownerInsIntervalRemaining',
